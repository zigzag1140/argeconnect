...
export default function Register() {
    ...
    return (
        <div className="min-h-screen w-full flex font-sans overflow-hidden">
            <Head title="Register - ArgeConnect" />
            ...
            <motion.div
                ...
                className="w-full lg:w-1/2 bg-white flex flex-col justify-center items-center px-8 md:px-16 py-8 overflow-y-auto"
            >
                <div className="w-full max-w-[448px]">
                    ...
                    <form onSubmit={submit} className="space-y-5">
                        ...
                        <motion.button
                            ...
                            whileTap={{ scale: 0.99 }}
                            disabled={processing}
                            className="w-full h-[48px] bg-[#2563EB] hover:bg-blue-700 text-white rounded-[10px] text-base font-normal shadow-md transition-all duration-200 flex items-center justify-center gap-2 font-sans mt-2"
                        >
